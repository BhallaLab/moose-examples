...
```
  ...
  Traceback (most recent call last):
    File "LIFxml_firing.py", line 47, in <module>
      IF1 = create_LIF()
    File "LIFxml_firing.py", line 32,INFO:root:Loading mechanism Gran_KCa_98 into library.
  _channels/LIF.morph.xml')
    File "/home1/dilawars/Work/GITHUB/DILAWAR/moose-core/_build/python/moose/neuroml/NeuroML.py", line 139, in readNeuroMLFromFile
      cellDict = mmlR.readMorphML(cell,params=params,lengthUnits=self.lengthUnits)
    File "/home1/dilawars/Work/GITHUB/DILAWAR/moose-core/_build/python/moose/neuroml/MorphML.py", line 267, in readMorphML
...
```
  ...
  malloc(): memory corruption
  , 0.0003306865692138672)
  ('after setting connectivity, t = ', 0.010616779327392578)
  ('Middle of setup, t = ', 0.010855436325073242)
  (1024, ', tot = ', 10536, ', numSynVec = ', array([10,  7, 13, ..., 15,  9,  5], dtype=uint32))
  ('after setup, t = ', 0.08195376396179199)
  Traceback (most recent call last):
    File "recurrentIntFire.py", line 114, in <module>
      make_network()
    File "recurrentIntFire.py", line 78, in make_network
...
```
  Info: Using threaded gsolve: 2 threadsReadKkit::setMethod: option  not known, using Exponential Euler (ee)
   t = ', 0.0004017353057861328)
  ('after setting connectivity, t = ', 0.010494470596313477)
  ('Middle of setup, t = ', 0.010826587677001953)
  (1024, ', tot = ', 10536, ', numSynVec = ', array([10,  7, 13, ..., 15,  9,  5], dtype=uint32))
  ('after setup, t = ', 0.07990741729736328)
  Traceback (most recent call last):
    File "recurrentLIF.py", line 120, in <module>
      make_network()
    File "recurrentLIF.py", line 82, in make_network
...
```
  Traceback (most recent call last):
    File "fig_a3.py", line 55, in <module>
      from cells import SpinyStellate
    File "/home1/dilawars/Work.SVN/GITHUB/BhallaLab/moose-examples/traub_2005/py/cells.py", line 36, in <module>
      import config
...
```
  Traceback (most recent call last):
    File "fig_a4c.py", line 56, in <module>
...
```
  Traceback (most recent call last):
    File "test_deepbasket.py", line 33, in <module>
...
```
  Traceback (most recent call last):
    File "test_nachans.py", line 38, in <module>
      import testutils
    File "/home1/dilawars/Work.SVN/GITHUB/BhallaLab/moose-examples/traub_2005/py/testutils.py", line 44, in <module>
      import config
    File "/home1/dilawars/Work.SVN/GITHUB/BhallaLab/moose-examples/traub_2005/py/config.py", line 33, in <module>
      import settings
    File "/home1/dilawars/Work.SVN/GITHUB/BhallaLab/moose-examples/traub_2005/py/settings.py", line 31, in <module>
      import exceptions
  ModuleNotFoundError: No module named 'exceptions'
  eNotFoundError: No module named 'exceptions'
```
...
```
  Traceback (most recent call last):
    File "test_spinystellate.py", line 33, in <module>
      from cell_test_util import SingleCellCurrentStepTest
    File "/home1/dilawars/Work.SVN/GITHUB/BhallaLab/moose-examples/traub_2005/py/cell_test_util.py", line 46, in <module>
      import config
    File "/home1/dilawars/Work.SVN/GITHUB/BhallaLab/moose-examples/traub_2005/py/config.py", line 33, in <module>
...
```
  Traceback (most recent call last):
    File "test_suppyrrs.py", line 33, in <module>
      from cell_test_util import SingleCellCurrentStepTest
    File "/home1/dilawars/Work.SVN/GITHUB/BhallaLab/moose-examples/traub_2005/py/cell_test_util.py", line 46, in <module>
      import config
    File "/home1/dilawars/Work.SVN/GITHUB/BhallaLab/moose-examples/traub_2005/py/config.py", line 33, in <module>
...
```
  Elements under /network[0]
  /network[0]/syns
  ('before connect t = ', 0.0003497600555419922)
  ('after connect t = ', 0.0003800392150878906)
  ('after setting connectivity, t = ', 0.010437488555908203)
  ('Middle of setup, t = ', 0.010679960250854492)
  (1024, ', tot = ', 10536, ', numSynVec = ', array([10,  7, 13, ..., 15,  9,  5], dtype=uint32))
  ('after setup, t = ', 0.07775402069091797)
  Traceback (most recent call last):
    File "recurrentIntFire.py", line 114, in <module>
      make_network()
    File "recurrentIntFire.py", line 78, in make_network
...
```
  ...
  ('', True)
  /syns
  ('before connect t = ', 0.00040030479431152344)
  ('after connect t = ', 0.0004298686981201172)
  ('after setting connectivity, t = ', 0.01163792610168457)
  ('Middle of setup, t = ', 0.01200103759765625)
  (1024, ', tot = ', 10536, ', numSynVec = ', array([10,  7, 13, ..., 15,  9,  5], dtype=uint32))
  ('after setup, t = ', 0.08085894584655762)
  Traceback (most recent call last):
    File "recurrentLIF.py", line 120, in <module>
      make_network()
    File "recurrentLIF.py", line 82, in make_network
